...
services/               # Business logic
  semantic_router.py    # Query intent classification (0.80/0.72 thresholds)
...
```python
# Semantic Router (query validation)
HARD_ACCEPT = 0.80  # Clearly on-topic
SOFT_ACCEPT = 0.72  # Borderline, log for review
# Below 0.72 = reject (off-domain)

# RAG Service (result confidence)
