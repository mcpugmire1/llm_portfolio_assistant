...
with st.sidebar:
    ...
    categories = sorted(set(story.get("category", "Uncategorized") for story in stories))
...
# Query Input
# -------------------
user_query = st.text_input("Ask about Matt’s experience (e.g., 'cloud modernization', 'capability building', 'payments')")
...
""", unsafe_allow_html=True)
        ...
        st.info("No matching stories found. Try a broader keyword like 'cloud', 'GenAI', or 'payments'.")
